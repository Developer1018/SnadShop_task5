...
const Footer = () => {
  ...
  return (
    <>
      {!adminRoute && (
        <>
          <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 bg-#8dfc81 text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
